  ...
  return (
    <div className="home__data">
      ...
      <p className="home__description">
        ...
        deserunt quibusdam expedita aperiam dolorum pariatur nostrum! Et eaque
        doloribus perferendis accusamus dolor? Consequatur neque itaque alias
        ipsam, atque provident.
      </p>
